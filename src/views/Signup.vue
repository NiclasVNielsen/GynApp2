<template>
    <div class="spaceBoth">
        ...
        <form @submit.prevent="Signup">
            ...
            <button @click="signInWithGoogle" class="altLogin google">
                <div>
            ...
            <div class="actionContainer">
                <router-link :to="'/login'" class="action">Login</router-link>
                <button type="submit" class="action target">Sign up</button>
            </div>
        </form>
    </div>
</template>
